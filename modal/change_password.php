	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" method="post" id="edit_password">
					<div id="result_ajax_pass"></div>
					...
					<div class="modal-footer">
						...
						<button type="submit" class="btn btn-primary" id="update_data_pass">Cambiar contraseña</button>
					</div>
				</form>
			</div>
		</div>
